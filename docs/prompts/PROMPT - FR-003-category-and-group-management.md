...
## Input:
Feature: "FR-003-category-and-group-management"

### Context:
- docs/CONTEXT.md
- docs/ARCHITECTURE.md
- docs/features/FR-003-category-and-group-management.md
...
### Output:
- Write to: docs/plans/FR-003-category-and-group-management-architecture.md
- Create ADRs in docs/adrs/ if required
- Update docs/features/FR-003-category-and-group-management.md Status section, append - current date and time  - "STEP 1. Architecture complete for feature " Featurename - duration worked
...
- docs/ARCHITECTURE.md
- docs/features/FR-003-category-and-group-management.md
- docs/plans/FR-003-category-and-group-management-architecture.md
- docs/adrs/
...
### Output:
- Write to: docs/plans/FR-003-category-and-group-management-plan.md
- Update docs/features/FR-003-category-and-group-management.md Status section, append - current date and time - "STEP 2. Planning complete" - duration worked
   - If the Status section doesn't exist, add it to the end of the file
...
- docs/features/FR-003-category-and-group-management.md
- docs/plans/FR-003-category-and-group-management-architecture.md
- docs/plans/FR-003-category-and-group-management-plan.md
- docs/adrs/
- .codex/enforcement/
...
### Output:
- Update docs/plans/FR-003-category-and-group-management-plan.md - mark the task complete.  
  - If all tasks for an epic is complete, mark the Epic off as well
- Update docs/features/FR-003-category-and-group-management.md Status section. append - current date and time - "Step 3. Task Implementation complete" - Epic Name - Task Name - duration to execute.
   - If the Status section doesn't exist, add it to the end of the file
