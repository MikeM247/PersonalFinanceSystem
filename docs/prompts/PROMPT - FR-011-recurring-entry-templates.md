...
## Input:
Feature: "FR-011-recurring-entry-templates"

### Context:
- docs/CONTEXT.md
- docs/ARCHITECTURE.md
- docs/features/FR-011-recurring-entry-templates.md
...
### Output:
- Write to: docs/plans/FR-011-recurring-entry-templates-architecture.md
- Create ADRs in docs/adrs/ if required
- Update docs/features/FR-011-recurring-entry-templates.md Status section, append current date and time and "STEP 1 â€” Architecture complete for feature " Featurename
...
- docs/ARCHITECTURE.md
- docs/features/FR-011-recurring-entry-templates.md
- docs/plans/FR-011-recurring-entry-templates-architecture.md
- docs/adrs/
...
### Output:
- Write to: docs/plans/FR-011-recurring-entry-templates-plan.md
- Update docs/features/FR-011-recurring-entry-templates.md Status section, append current date and time and "STEP 2. Planning complete"
   - If the Status section doesn't exist, add it to the end of the file
...
- docs/features/FR-011-recurring-entry-templates.md
- docs/plans/FR-011-recurring-entry-templates-architecture.md
- docs/plans/FR-011-recurring-entry-templates-plan.md
- docs/adrs/
- .codex/enforcement/
...
### Output:
- Update docs/plans/FR-011-recurring-entry-templates-plan.md - mark the task complete.  
  - If all tasks for an epic is complete, mark the Epic off as well
- Update docs/features/FR-011-recurring-entry-templates.md Status section. append current date and time - duration to execute - name of the Feature - Epic Name - Task Name. "Feature Implementation complete".
   - If the Status section doesn't exist, add it to the end of the file
