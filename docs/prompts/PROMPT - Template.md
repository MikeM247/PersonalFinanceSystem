...
### Output:
- Write to: docs/plans/<feature-name>-architecture.md
- Create ADRs in docs/adrs/ if required
- Update docs/features/<feature-name>.md Status section, append - current date and time  - "STEP 1. Architecture complete for feature " Featurename - duration worked
...
- Update docs/features/<feature-name>.md Status section, append - current date and time - "STEP 2. Planning complete" - duration worked
   - If the Status section doesn't exist, add it to the end of the file
...
### Output:
- Update docs/plans/<feature-name>-plan.md - mark the task complete.  
